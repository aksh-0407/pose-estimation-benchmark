...
is a grazing foot projection (noisy to teleport spikes), and he cannot be cross-checked for
identity ( to  split ids and over-mint). The second-innings deep-field clips **M2_2_3_\*** run
