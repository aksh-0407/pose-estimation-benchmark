...
> **P1** deep-field recall gap → single-camera players → **03** no binding cue on grazing/facing
> cameras → split identity + **05** ID over-mint → risky stitch + mean-of-fragments emission →
