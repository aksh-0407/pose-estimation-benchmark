...
#
# Wraps scripts/inference/run_phase1_l40s.py: native bt1/bt2/bt3 layout under
...
#   python scripts/inference/run_phase1_l40s.py --model-id rtmpose_x_body8 \
...
#   bash scripts/inference/run_rtmpose_x_l40s.sh --groups bt1 --frame-limit 100
...
"${PYTHON_BIN}" scripts/inference/run_phase1_l40s.py \
  --pose-data "${POSE_DATA}" \
